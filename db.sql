...
--
-- Host: localhost:3306
-- Generation Time: Apr 03, 2022 at 06:11 AM
...
CREATE TABLE `tbl_module` (
  ...
  `module_tooltip` text COLLATE utf8_unicode_ci,
...
(13, 'si-wallet', 'Expense', 'Expenses', 'Add new expense, view expenses', 0, 1, 1),
(14, 'si-users', 'Customer', 'Customers & Groups', 'Add new customer, view customers and manage customers groups in your company', 0, 1, 1),
(15, 'si-folder-alt', 'Reports', 'Reports', 'View sales report, products reports, expenses report and so many', 0, 1, 1),
(16, 'si-badge', 'Subscription', 'Subscriptions', 'View subscription, Add new subscription', 55, 1, 1),
(17, 'si-grid', 'Branch', 'Branches & Zones', 'Create, Edit and manage branches and ones in your company', 0, 1, 1),
(18, 'si-wallet', 'Loans', 'Loans & Returns', 'Manage customer loans and returns, alter loans settings and much more...', 0, 1, 1),
(19, 'si-refresh', 'Services', 'Services', 'Access system services', 0, 1, 1),
(20, 'si-notebook', 'Company', 'Companies', 'Manage system companies', 0, 1, 0);
...
(1, 'sa', '$2y$10$GBiHXrffUwJauk20TPgcPOiPhKSBPv.TQQJyKJiehpo7bJFi9TGxu', '2022-03-30 21:14:59', 1, 1, 0, 'Halfa Salum', 1, '2', 'zemburetheson@gmail.com', 'avata.jpg', 1, 1, NULL, NULL, NULL, 1, 1),
...
--
ALTER TABLE `tbl_module_control`
  MODIFY `control_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=105;
...
--
ALTER TABLE `tbl_role_control`
  MODIFY `role_control_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=439;
...
--
ALTER TABLE `tbl_users_logs`
  MODIFY `log_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=843;
