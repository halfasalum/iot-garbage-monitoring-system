                                    ...
                                    <div class="block block-themed block-rounded block-shadow">
                                        ...
                                        <div class="block-content bg-body-light">
                                            <div class="form-group text-center">
                                                <!--<a class="link-effect text-muted mr-10 mb-5 d-inline-block" href="<?php /*echo site_url('Auth/company') */?>">
                                                    <i class="fa fa-plus-circle mr-5"></i> Create Company
                                                </a>-->
                                                <a class="link-effect text-muted mr-10 mb-5 d-inline-block" href="<?php echo site_url('Auth/account') ?>">
