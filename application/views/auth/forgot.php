                        ...
                        <div class="hero-static col-md-6 col-xl-4 d-flex align-items-center bg-white invisible" data-toggle="appear" data-class="animated fadeInRight">
                            <div class="content content-full">
                                ...
                                <div class="px-30 py-10">
                                    ...
                                    <h2 class="h5 font-w400 text-muted mb-0">Please enter your username</h2>
                                </div>
                                ...
                                <?php echo form_open("", array('class'=>'px-30')); ?>
                                    ...
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-sm btn-hero btn-alt-primary" name="forget">
                                            <i class="fa fa-lock mr-10"></i> Password Reminder
                                        </button>
                                        <div class="mt-30">
