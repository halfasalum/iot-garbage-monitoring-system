...
<div class="form-group row gutters-tiny mb-0 items-push">
	<div class="col-md-12">
		<?php if (isset($user)){
			if ($user->user_status == 1){
				...
				<h1 class="text-danger text-center"> Are you sure you want to delete <i class="fa fa-question-circle"></i></h1>
					<h3 class="text-center">User : <?php if (isset($user)){ echo $user->user_fullname; } ?></h3>
				<p class="text-center">
					<?php
		...
		<?php
				...
				echo anchor("Manage/users","<p class='text-center'><button class='btn btn-alt-success'><i class='fa fa-refresh'></i> Click to refresh the page</button></p>");
			}
		} ?>
