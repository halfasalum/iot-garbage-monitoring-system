<?php if(isset($message) && $message['description'] != null):  ?>
	...
	<!-- END Alert -->
<?php endif; ?>
<h2 class="content-heading">Expense Details Report</h2>
<?php echo form_open(""); ?>
<div class="form-group row gutters-tiny mb-0 items-push">
	...
	<div class="col-md-3">
		...
		<button type="submit" class="btn btn-primary btn-sm btn-block" id="saveModal" c="Reports" f="expenseDetail" d="1" o="1" name="run">Run</button>
	</div>
	<div class="col-md-3">
		<label  for="exampleInputPassword2"> </label>
	...
	<div class="col-md-12">
		<table style="font-size: 11px;!important;" class="table  table-hovertable-sm">
			...
			<tr>
				...
				<th class="text-center">EXPENSE USER</th>
			</tr>
			</thead>
			<tbody>
